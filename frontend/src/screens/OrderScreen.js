                ...
                <Col md={8}>
                    <ListGroup variant='flush'>
                        <ListGroup.Item>
                            ...
                            { order.isDelivered ? <Message variant='success'>Доставка: {order.deliveredAt}</Message> :
                                <Message variant='danger'>Не доставленно</Message>
                            }
                        </ListGroup.Item>
                        ...
                        <ListGroup.Item>
                            ...
                            { order.isPaid ? <Message variant='success'>Оплачено По: {order.paidAt}</Message> :
                        ...
                        <ListGroup.Item>
                            <h2>Элементы заказа</h2>
                                { order.orderItems.length === 0 ? <Message>Заказ пуст!!</Message> : (
                                    <ListGroup variant='flush'>
                        ...
                        <ListGroup variant='flush'>
                            ...
                            {!order.isPaid && (
                                <ListGroup.Item>
                                    {loadingPay && <Loader />}
                                    {!sdkReady ? <Loader /> : (
                                        <PayPalButton amount={order.price} onSuccess={successPaymentHandler} />
                                    )}
                                </ListGroup.Item>
                            )}
