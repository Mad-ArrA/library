                    ...
                    <Col md={6}>
                        ...
                        <ListGroup variant='flush'>
                            ...
                            <ListGroup.Item>
                                ...
                                <Form onSubmit={submitHandler}>
                                    <Form.Group controlId='rating'>
                                        ...
                                        onChange={(e) => setRating(e.target.value)}>
                                            ...
                                            <option value='1'>1 - Скучная</option>
                                            <option value='2'>2 - Пойдёт</option>
                                            <option value='3'>3 - Нормальная</option>
                                            <option value='4'>4 - Интересная</option>
                                            <option value='5'>5 - Невероятная</option>
                                        </Form.Control>
                                    </Form.Group>
                                ...
                                (<Message>Пожалуйста <Link to='/login'>Авторизуйтесь</Link> для написания отзыва</Message>
                                )}
                            </ListGroup.Item>
                        </ListGroup>
                    </Col>
