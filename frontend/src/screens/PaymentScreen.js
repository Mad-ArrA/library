    ...
    return (
        <FormContainer>
            ...
            <Form onSubmit={submitHandler}>
                ...
                <Col>
                    <Form.Check type='radio' label='PayPal или банковской картой' id='PayPal' name='paymentMethod'
                    value='PayPal' checked  onChange={(e) => { setPaymentMethod(e.target.value) }}>
                    </Form.Check>

                    <Form.Check type='radio' label='Доставка' id='Stripe' name='paymentMethod'
